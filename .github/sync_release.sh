...
UPSTREAM_REPO="https://github.com/MiSTer-devel/VIC20_MiSTer.git"
CORE_NAME=(VIC20)
...
UPSTREAM_CORE_NAME=(VIC20)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(VIC20.qpf)
COMPILATION_OUTPUT=(output_files/VIC20.rbf)
